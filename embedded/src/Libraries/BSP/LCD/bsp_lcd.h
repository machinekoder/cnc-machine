...
/*
*********************************************************************************************************
*                              CHARACTER-BASED BINARY REPRESENTATION
*********************************************************************************************************
*/
...
#define  BSP_LCD_COLOR_GRAY                                  0x8410
#define  BSP_LCD_COLOR_MARRON                                0x8000
#define  BSP_LCD_COLOR_OLIVE                                 0x8400
#define  BSP_LCD_COLOR_GREEN                                 0x0400
#define  BSP_LCD_COLOR_TEAL                                  0x0410
#define  BSP_LCD_COLOR_NAVY                                  0x0010
#define  BSP_LCD_COLOR_PURPLE                                0x8010
#define  BSP_LCD_COLOR_SILVER                                0xC618
#define  BSP_LCD_COLOR_RED                                   0xF800
#define  BSP_LCD_COLOR_YELLOW                                0xFFE0
#define  BSP_LCD_COLOR_LIME                                  0x07E0
#define  BSP_LCD_COLOR_AQUA                                  0x07FF
#define  BSP_LCD_COLOR_ORANGE                                0xFC08
...
/*
*********************************************************************************************************
*                                               COLOR, PIXELS and TEXT
*********************************************************************************************************
*/

typedef  CPU_INT16U  BSP_LCD_PIXEL;                             /* LCD pixels.                                          */
typedef  CPU_INT16U  BSP_LCD_COLOR;                             /* Color RGB 565                                        */
typedef  CPU_INT08U  BSP_LCD_TEXT_POS;                          /* Text position line and colums                        */
...
typedef  struct  bsp_lcd_font_char {
    CPU_INT08U   Width;                                         /* Character width.                                     */
    CPU_INT08U   Dist;                                          /* Next character distance.                             */
    CPU_INT08U   NbrBytes;                                      /* Number of bytes.                                     */
    CPU_INT08U  *BitMapPtr;                                     /* Pointer to the character bitmap.                     */
} BSP_LCD_FONT_CHAR;

typedef  struct  bsp_lcd_font {                                 
    CPU_CHAR           *NamePtr;                                /* Font name.                                           */
    CPU_CHAR            CharStart;                              /* Font first character.                                */
    CPU_CHAR            CharEnd;                                /* Font last  character.                                */
    BSP_LCD_PIXEL       Width;                                  /* Character width.                                     */
    BSP_LCD_PIXEL       Height;                                 /* Character height.                                    */
    BSP_LCD_FONT_CHAR  *CharInfoTbl;                            /* Character information Table.                         */
} BSP_LCD_FONT;
...
typedef  struct  bsp_lcd_img {
   CPU_CHAR    *NamePtr;                                        /* Image name.                                          */
   CPU_INT16U   Width;                                          /* Image width.                                         */
   CPU_INT16U   Height;                                         /* Image Height.                                        */
   CPU_INT16U  *BitmapPtr;                                      /* Image bitmap.                                        */
} BSP_LCD_IMG;
...
void              BSP_LCD_TextLineClr        (BSP_LCD_TEXT_POS   col);                                     
...
void              BSP_LCD_BarGraphDraw       (BSP_LCD_PIXEL      x,
                                              ...
                                              BSP_LCD_COLOR      lev_color,
                                              CPU_INT08U         lev_pct);

void              BSP_LCD_BitmapDraw         (BSP_LCD_PIXEL      x,
                                              BSP_LCD_PIXEL      y,
                                              BSP_LCD_PIXEL      width,
                                              BSP_LCD_PIXEL      height,
                                              BSP_LCD_COLOR     *p_bitmap);

void              BSP_LCD_ImgTblSet          (BSP_LCD_IMG      **p_img_tbl);
